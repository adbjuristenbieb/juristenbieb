...
def run_test():
    with sync_playwright() as p:
        ...
        print("👆 Klik op 'Show more' bij Faculty (via JS-fallback)")
        page.evaluate("""() => {
        ...
        print("✅ Klik op 'Leiden Law School' (via label forceClick)")
        try:
            ...
            print(f"⚠️ Leiden Law School klik faalde: {e}")
        take_screenshot(page, "03_lawschool_clicked")

        print("🌍 Klik op taal 'nl' (via label forceClick)")
        try:
            ...
            print(f"⚠️ Language klik faalde: {e}")
        ...
        print("✅ Klik op 'Institute of Public Law' (via label forceClick)")
        try:
            ...
            print(f"⚠️ Collection klik faalde: {e}")
        take_screenshot(page, "06_collection_selected")

        print("✅ Filters voltooid — check nu of resultaten zijn verlaagd")
        time.sleep(2)
